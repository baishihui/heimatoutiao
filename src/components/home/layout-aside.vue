...
<div class="layout-aside">
    ...
    <!-- 配置路由 -->
 <el-menu :collapse="collaspse" :style="{width:collaspse ? '60px' : '230px'}" router background-color="#323745" text-color="#adafb5" active-text-color="#ffd04b" style="width:231px">
       <el-menu-item>
